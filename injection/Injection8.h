#ifndef INJECTION_8_H
#define INJECTION_8_H

#include <iostream>
#include <sstream>

// DEPENDECY INJECTION WITH TEMPLATES AND CONCEPTS
//
...
template <class T>
concept DBase = std::is_base_of<D, T>::value;

template <DBase T> class B1 {
  T d;
